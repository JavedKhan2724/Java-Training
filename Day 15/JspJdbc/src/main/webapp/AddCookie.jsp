...
<body>
	<%
		Cookie ckGaurav,ckHarshit,ckJaved;
	
		ckGaurav = new Cookie("Gaurav","88");
		ckGaurav.setMaxAge(1000*24*60*60);
		response.addCookie(ckGaurav);
		...
		out.println("Cookies Created Now U Can Eat It...");
	%>
</body>
</html>