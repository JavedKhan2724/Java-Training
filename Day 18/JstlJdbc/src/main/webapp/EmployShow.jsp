...
<body>
	<sql:setDataSource var="conn" driver="com.mysql.cj.jdbc.Driver" url="jdbc:mysql://localhost:3306/infinite" user="root" password="india@123"/>
		...
		<table border="3">
			...
			<c:forEach var="employ" items="${employQuery.rows }">
				<tr>
					...
					<td><a href="EmployUpdate.jsp?empno=${empno }"><button>Update</button></a></td>
					<td><a href="EmployDelete.jsp?empno=${empno }"><button><b>DELETE</b></button></a></td>
				</tr>
			</c:forEach>
		</table>
</body>
