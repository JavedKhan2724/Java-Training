...
public class LibraryDAO {
	...
	public TranBook searchBook(String user,int bookId)throws ClassNotFoundException, SQLException{
		Connection connection = ConnectionHelper.getConnection();
	...
	public String returnBook(String user,int bookId) throws ClassNotFoundException, SQLException{
		Connection connection = ConnectionHelper.getConnection();
		TranBook tranBook = searchBook(user, bookId);
	...
	public String issueBook(String userName, int bookId) throws ClassNotFoundException, SQLException{
		...
		if(count==0){
			...
			return "Book ID "+bookId+"User Name "+userName+" is already issued";
		}
